...
<div class="contact">
<!--Page Title-->
<section class="page-title text-center" style="background-image:url(assets/images/smktelkom.jpg);">
    <div class="container">
                ...
                <div class="address-block">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3>Location</h3>
                            <p>Jl. Danau Ranau Sawojajar Kota Malang
                                <br>SMK TELKOM MALANG</p>
                        </div>
                    </div>
                    <!-- Phone -->
                    <div class="media">
